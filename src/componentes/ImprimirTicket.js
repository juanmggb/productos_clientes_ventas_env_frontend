...
const ImprimirTicket = ({estado, datosVenta, reset, manejarFinalizarVenta, DESCUENTO}) => {
          ...
          <Overlay>
            <ContenedorVentana>
              ...
              <ReactToPrint 
                ...
                onAfterPrint = {() => {
                    reset(); manejarFinalizarVenta()}}/>
                <div style = {{display: 'none'}}>
                  <TicketVenta ref={componentRef} datosVenta = {datosVenta} DESCUENTO={DESCUENTO}/>
                </div>
            </ContenedorVentana>
          </Overlay>
        }
