      ...
      {error && <Mensaje variant="danger">{error}</Mensaje>}
      {
        ...
        <Principal>
          <FormularioContenedor>
            <LogoDiv><Logo src={'../imagenes/Logo.png'}/></LogoDiv>
            <Formulario autoComplete= 'off' onSubmit={manejarSubmit}>
              <Form.Group style= {{width: '90%', gridArea: 'User'}} controlId="username">
                  <Form.Label style= {{width: '100%', fontWeight: 'bold', color: 'rgb(30,50,120)'}}>Nombre de usuario</Form.Label>
                  <Form.Control
                    type="text"
                    value={username}
              ...
              <Form.Group style= {{width: '90%', gridArea: 'Password'}} controlId="password">
              <Form.Label style= {{width: '100%', fontWeight: 'bold', color: 'rgb(30,50,120)'}}>Contraseña</Form.Label>
                  <Form.Control
                    type="password"
                    value={password}
              ...
              <Button type="submit" variant="primary" style= {{color: 'rgba(220,220,220)', backgroundColor: 'rgba(30,60,90)', fontWeight: 'bold'}}>
                Iniciar sesión
              </Button>
            </Formulario>
          </FormularioContenedor>
